...
- read-only публичный профиль организатора без email, даты рождения и истории участия;
...
- вкладки «Планы» и «Организую» для участия, заявок и управления созданными событиями;
...
Основная нижняя навигация mobile состоит из вкладок «Главная», «Планы», «Организую», «Чаты» и
«Профиль». «Планы» содержат только внешние активности, к которым пользователь подключился;
собственные события и их архив находятся в «Организую». Pending-заявки и оба архива открываются
вложенными экранами, а не постоянными вкладками.
Создание активности доступно на вкладке «Организую».
