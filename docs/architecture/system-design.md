...
блокировки, административная панель, платежи и чаты. Для них сохраняются границы расширения, но не
создаются неиспользуемые runtime-компоненты, таблицы или endpoints.
